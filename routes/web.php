...
Route::get('/players/create', [PlayerController::class, 'create'])->name('player_create');
Route::post('/players', [PlayerController::class, 'store'])->name('player_store');
Route::get('/players/{id}/edit', [PlayerController::class, 'edit'])->name('player_edit');
Route::put('/players/{id}', [PlayerController::class, 'update'])->name('player_update');
Route::delete('/players/{id}', [PlayerController::class, 'destroy'])->name('player_destroy');
